...
import {clearCart, removeCartItem, plusCartItem, minusCartItem} from '../../redux/cart_reducer';
...
const Cart = () => {
  ...
  const addedPies = Object.keys(items).map(key => {
            ...
            totalCount ? <div className="cart">
                  ...
                  <div className="cart__bottom">
                    <div className="cart__bottom-details">
                      <span> Всего пирогов: <b>{totalCount} шт.</b> </span>
                    ...
                    <div className="cart__bottom-buttons">
                      ...
                      <div onClick={onPayment} className="button pay-btn">
                ...
                : <div className="cart cart--empty">
                  ...
                  <p>
                    Вы еще не заказали ни одного пирога.
                    <br/>
                    Чтобы заказать пироги, вернитесь на главную страницу.
                  </p>
